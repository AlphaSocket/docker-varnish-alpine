...
ADD imports/bin/setup /usr/local/bin/setup/1518786658
ADD imports/bin/config /usr/local/bin/config/1518786658
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518786658 1>/dev/stdout 2>/dev/stderr

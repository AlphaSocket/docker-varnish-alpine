...
ADD imports/bin/setup /usr/local/bin/setup/1518702918
ADD imports/bin/config /usr/local/bin/config/1518702918
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518702918 1>/dev/stdout 2>/dev/stderr

...
ADD imports/bin/setup /usr/local/bin/setup/1521475391
ADD imports/bin/config /usr/local/bin/config/1521475391
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1521475391 1>/dev/stdout 2>/dev/stderr

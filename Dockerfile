...
ADD imports/bin/setup /usr/local/bin/setup/1518575169
ADD imports/bin/config /usr/local/bin/config/1518575169
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518575169 1>/dev/stdout 2>/dev/stderr

...
ADD imports/bin/setup /usr/local/bin/setup/1521800943
ADD imports/bin/config /usr/local/bin/config/1521800943
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1521800943 1>/dev/stdout 2>/dev/stderr

...
ADD imports/bin/setup /usr/local/bin/setup/1518701976
ADD imports/bin/config /usr/local/bin/config/1518701976
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518701976 1>/dev/stdout 2>/dev/stderr

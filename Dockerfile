...
MANTAINTER alphasocket <22446807+AlphaSocket@users.noreply.github.com>
...
ENV \
	...
	CONFIG_PATHS_CONF_VARNISH_SERVER="${SETUP_VARNISH_CONF}/default.vcl"
...
ENTRYPOINT ["/bin/sh", "-c"]
CMD ["/usr/local/bin/config && varnishd"]
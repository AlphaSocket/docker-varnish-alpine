...
ADD imports/bin/setup /usr/local/bin/setup/1518311089
ADD imports/bin/config /usr/local/bin/config/1518311089
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518311089 1>/dev/stdout 2>/dev/stderr
